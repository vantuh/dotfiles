...
```bash
# 1. Move it back into the managed extensions surface
mv home/dot_pi/agent/archive/<name> home/dot_pi/agent/extensions/<name>
# 2. Apply the restored extension
chezmoi apply ~/.pi/agent/extensions/<name>
