...
- `home/dot_config/lazyvim/` — the current LazyVim setup;
- `home/dot_config/nvim/` — my own config.

1. Read `home/dot_config/lazyvim/lazy-lock.json` and find the exact `LazyVim` commit.
...
3. Analyze the effective combination of:
   ...
   - extras from `home/dot_config/lazyvim/lazyvim.json`;
   - local overrides from `home/dot_config/lazyvim/lua/`;
