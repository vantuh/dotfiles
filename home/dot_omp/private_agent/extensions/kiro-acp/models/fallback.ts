...
/** omp ProviderModelConfig.thinking (pi used thinkingLevelMap, which omp
 * ignores). Wire wire-efforts exposed: minimal aliases to low on the wire. */
export const KIRO_THINKING = {
  mode: "effort",
