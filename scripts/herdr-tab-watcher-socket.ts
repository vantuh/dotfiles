 ...
 *
 * Event-driven variant of herdr-tab-watcher.ts. Instead of forking the `herdr`
 ...
 *
 * Label heuristics and state semantics are shared with the polling watcher:
 ...
 *
 * Usage: herdr-tab-watcher-socket [--state FILE] [--reconcile-interval MS]
 */
...
function log(msg: string): void {
  console.error(`herdr-tab-watcher-socket: ${msg}`);
}
