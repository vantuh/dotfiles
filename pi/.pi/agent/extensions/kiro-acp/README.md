...
host is `pi`. Stow maps it to `~/.pi/agent/extensions/kiro-acp`.
...
|---|---|---|
| Repo | [`pi/.pi/agent/extensions/kiro-acp`](.) | [`omp/.omp/agent/extensions/kiro-acp`](../../../../../omp/.omp/agent/extensions/kiro-acp) |
