...
export const KIRO_MODELS = [
  ...
  { id: "gpt-5.6-sol", name: "GPT-5.6 Sol (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text"] as any, cost: ZERO_COST, contextWindow: 272000, maxTokens: 8192 },
  ...
  { id: "gpt-5.6-luna", name: "GPT-5.6 Luna (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text"] as any, cost: ZERO_COST, contextWindow: 272000, maxTokens: 8192 },
  { id: "claude-opus-4.7", name: "Claude Opus 4.7 (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text", "image"] as any, cost: ZERO_COST, contextWindow: 1000000, maxTokens: 32000 },
  { id: "claude-opus-4.6", name: "Claude Opus 4.6 (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text", "image"] as any, cost: ZERO_COST, contextWindow: 1000000, maxTokens: 32000 },
  ...
  { id: "claude-opus-4.5", name: "Claude Opus 4.5 (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text", "image"] as any, cost: ZERO_COST, contextWindow: 200000, maxTokens: 32000 },
  { id: "claude-sonnet-4.5", name: "Claude Sonnet 4.5 (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text", "image"] as any, cost: ZERO_COST, contextWindow: 200000, maxTokens: 16384 },
  { id: "claude-sonnet-4", name: "Claude Sonnet 4 (Kiro)", reasoning: true, thinkingLevelMap: KIRO_THINKING_LEVEL_MAP, input: ["text", "image"] as any, cost: ZERO_COST, contextWindow: 200000, maxTokens: 16384 },
